...
const s = {
  ...
  inputCard: { maxWidth: '600px', margin: '0 auto', background: 'rgba(0, 217, 255, 0.03)', backdropFilter: 'blur(20px)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '24px', padding: '3rem', boxShadow: '0 0 60px rgba(0, 217, 255, 0.2)' },
  ...
  loaderRing: { position: 'absolute', inset: 0, border: '4px solid rgba(0, 217, 255, 0.2)', borderTop: '4px solid #00D9FF', borderRadius: '50%', animation: 'spin 1s linear infinite' },
  loaderRing2: { position: 'absolute', inset: '15px', border: '4px solid rgba(14, 165, 233, 0.2)', borderTop: '4px solid #0EA5E9', borderRadius: '50%', animation: 'spin 1.5s linear infinite reverse' },
  loaderIcon: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', color: '#00D9FF', animation: 'pulse 2s infinite' },
  ...
  loadingBar: { maxWidth: '400px', height: '4px', background: 'rgba(0, 217, 255, 0.2)', borderRadius: '2px', margin: '0 auto 2rem', overflow: 'hidden' },
  loadingBarFill: { height: '100%', background: 'linear-gradient(90deg, #00D9FF, #0EA5E9)', animation: 'loading 2s ease infinite', borderRadius: '2px', boxShadow: '0 0 10px rgba(0, 217, 255, 0.5)' },
  cancelBtn: { display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(239,68,68,0.2)', border: '2px solid rgba(239,68,68,0.4)', color: '#fca5a5', padding: '1rem 2rem', borderRadius: '16px', cursor: 'pointer', fontSize: '1rem', fontWeight: '700', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', marginTop: '1rem' },
  ...
  pdfBtn: { display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', border: 'none', color: '#000000', padding: '1rem 2rem', borderRadius: '16px', cursor: 'pointer', fontSize: '1rem', fontWeight: '700', boxShadow: '0 0 30px rgba(0, 217, 255, 0.4)', textTransform: 'uppercase', letterSpacing: '0.05em' },
  ...
  reportUrl: { fontSize: '1rem', color: '#D1D5DB', marginBottom: '0.25rem' },
  reportDate: { fontSize: '0.9rem', color: '#D1D5DB' },
  ...
  scoreCard: { background: 'rgba(0, 217, 255, 0.03)', backdropFilter: 'blur(20px)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '24px', padding: '3rem', marginBottom: '2rem', boxShadow: '0 0 60px rgba(0, 217, 255, 0.2)' },
  ...
  scoreProgress: { transition: 'stroke-dasharray 2s cubic-bezier(0.4, 0, 0.2, 1)' },
  scoreText: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center' },
  scoreNum: { display: 'block', fontSize: '3.5rem', fontWeight: '700', lineHeight: 1 },
  scoreMax: { fontSize: '1.25rem', color: '#D1D5DB', fontWeight: '600' },
  scoreInfo: { flex: 1 },
  scoreTitle: { fontSize: '1.75rem', fontWeight: '700', marginBottom: '1rem', color: '#FFFFFF' },
  gradeTag: { display: 'inline-block', padding: '0.75rem 1.5rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '16px', fontSize: '1.25rem', fontWeight: '700', marginBottom: '1.5rem', color: '#00D9FF' },
  scoreSummary: { fontSize: '1.1rem', lineHeight: '1.7', color: '#D1D5DB' },
  ...
  h4: { fontSize: '1.1rem', fontWeight: '600', marginBottom: '1rem', color: '#FFFFFF' },
  ...
  kwCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', cursor: 'pointer', border: '1px solid rgba(0, 217, 255, 0.1)' },
  kwTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem', gap: '1rem' },
  kwName: { fontSize: '1.1rem', fontWeight: '600', color: '#FFFFFF', lineHeight: '1.4' },
  oppBadge: { padding: '0.375rem 0.875rem', borderRadius: '12px', fontSize: '0.75rem', fontWeight: '700', whiteSpace: 'nowrap', border: '1px solid rgba(0, 217, 255, 0.2)' },
  kwStats: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  kwStat: { display: 'flex', flexDirection: 'column' },
  kwLabel: { fontSize: '0.85rem', color: '#D1D5DB', marginBottom: '0.25rem' },
  kwVal: { fontSize: '1.25rem', fontWeight: '700', color: '#FFFFFF' },
  contentGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem', marginBottom: '2rem' },
  statCard: { display: 'flex', alignItems: 'center', gap: '1.5rem', padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  statIcon: { width: '60px', height: '60px', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#00D9FF', flexShrink: 0, background: 'rgba(0, 217, 255, 0.1)' },
  statLabel: { fontSize: '0.875rem', color: '#D1D5DB', marginBottom: '0.5rem' },
  statValue: { fontSize: '1.5rem', fontWeight: '700', color: '#FFFFFF' },
  ...
  recBox: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '16px' },
  recList: { display: 'flex', flexDirection: 'column', gap: '0.75rem' },
  recItem: { display: 'flex', alignItems: 'center', gap: '0.75rem', color: '#D1D5DB', lineHeight: '1.6' },
  metaGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' },
  metaCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  metaTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  metaContent: { fontSize: '0.9rem', color: '#D1D5DB', lineHeight: '1.5', wordBreak: 'break-word' },
  techGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '2rem' },
  techCard: { padding: '2rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)', textAlign: 'center' },
  techScore: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' },
  techCircle: { width: '80px', height: '80px', borderRadius: '50%', border: '6px solid', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.75rem', fontWeight: '700' },
  techLabel: { fontSize: '0.95rem', color: '#D1D5DB', fontWeight: '600' },
  ...
  compCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  compHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  compName: { fontSize: '1.25rem', color: '#FFFFFF' },
  compScore: { padding: '0.5rem 1rem', borderRadius: '12px', fontSize: '1.1rem', fontWeight: '700', color: '#000000', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)' },
  compStats: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  compStat: { display: 'flex', flexDirection: 'column' },
  compLabel: { fontSize: '0.85rem', color: '#D1D5DB', marginBottom: '0.25rem' },
  prioritySection: { marginBottom: '1rem' },
  priorityHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.25rem 1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', cursor: 'pointer', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', border: '1px solid rgba(0, 217, 255, 0.1)' },
  priorityTitle: { display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '1.1rem', fontWeight: '700', color: '#FFFFFF', margin: 0 },
  priorityCount: { padding: '0.25rem 0.75rem', background: 'rgba(0, 217, 255, 0.2)', borderRadius: '12px', fontSize: '0.875rem', marginLeft: '0.5rem', color: '#00D9FF' },
  priorityItems: { padding: '1rem 1.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '0 0 16px 16px', marginTop: '-8px' },
  priorityItem: { display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 0', borderBottom: '1px solid rgba(0, 217, 255, 0.1)', color: '#D1D5DB', lineHeight: '1.6' },
  impactGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '2rem' },
  impactCard: { padding: '2rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.2)', textAlign: 'center' },
  impactLabel: { fontSize: '0.95rem', color: '#00D9FF', marginBottom: '1rem', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' },
  impactChange: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', fontSize: '1.75rem', fontWeight: '700' },
  impactCurrent: { color: '#D1D5DB' },
  impactArrow: { color: '#00D9FF' },
  impactProjected: { color: '#00D9FF' },
  impactIncrease: { fontSize: '1.25rem', color: '#00D9FF', background: 'rgba(0, 217, 255, 0.1)', padding: '0.25rem 0.75rem', borderRadius: '12px' },
  vitalsBox: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px' },
  ...
  vitalName: { display: 'block', fontSize: '0.875rem', color: '#D1D5DB', marginBottom: '0.5rem', fontWeight: '600' },
  vitalVal: { display: 'block', fontSize: '1.1rem', color: '#FFFFFF', fontWeight: '600' },
  timelineCard: { position: 'relative', paddingLeft: '2rem', marginBottom: '2rem', borderLeft: '2px solid rgba(0, 217, 255, 0.3)' },
  timelineHeader: { display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' },
  timelineDot: { position: 'absolute', left: '-9px', width: '16px', height: '16px', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', borderRadius: '50%', border: '3px solid #000000', boxShadow: '0 0 10px rgba(0, 217, 255, 0.5)' },
  timelineTitle: { fontSize: '1.1rem', fontWeight: '700', color: '#00D9FF', textTransform: 'capitalize', margin: 0 },
  timelineTasks: { display: 'flex', flexDirection: 'column', gap: '0.75rem' },
  timelineTask: { display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem', background: 'rgba(0, 217, 255, 0.03)', borderRadius: '12px', color: '#D1D5DB', lineHeight: '1.6' },
};
