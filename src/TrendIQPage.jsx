...
const s = {
  ...
  header: { padding: '1.5rem 2rem', borderBottom: '1px solid rgba(0, 217, 255, 0.2)', backdropFilter: 'blur(10px)', position: 'sticky', top: 0, zIndex: 10, background: 'rgba(0, 0, 0, 0.8)' },
  backBtn: { display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(0, 217, 255, 0.05)', border: '1px solid rgba(0, 217, 255, 0.2)', color: '#00D9FF', padding: '0.75rem 1.5rem', borderRadius: '12px', cursor: 'pointer', fontSize: '0.95rem', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', fontWeight: '600' },
  hero: { textAlign: 'center', padding: '5rem 2rem 3rem', position: 'relative' },
  heroIcon: { position: 'relative', display: 'inline-flex', padding: '2rem', background: 'rgba(0, 217, 255, 0.1)', borderRadius: '30px', marginBottom: '2rem', border: '2px solid rgba(0, 217, 255, 0.3)', boxShadow: '0 0 60px rgba(0, 217, 255, 0.3)', color: '#00D9FF' },
  sparkle: { position: 'absolute', top: '10px', right: '10px', color: '#00D9FF', animation: 'sparkle 2s infinite' },
  title: { fontSize: '3.5rem', fontWeight: '700', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: '1rem', letterSpacing: '-0.02em' },
  subtitle: { fontSize: '1.25rem', color: '#D1D5DB', maxWidth: '600px', margin: '0 auto', lineHeight: '1.6' },
  main: { maxWidth: '1200px', margin: '0 auto', padding: '2rem', position: 'relative', zIndex: 1 },
  inputCard: { maxWidth: '700px', margin: '0 auto', background: 'rgba(0, 217, 255, 0.03)', backdropFilter: 'blur(20px)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '24px', padding: '3rem', boxShadow: '0 0 60px rgba(0, 217, 255, 0.2)' },
  modeSection: { marginBottom: '2rem' },
  label: { display: 'block', color: '#D1D5DB', fontSize: '0.95rem', marginBottom: '0.75rem', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' },
  modeButtons: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  modeBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: '1rem', background: 'rgba(0, 217, 255, 0.05)', border: '2px solid rgba(0, 217, 255, 0.2)', borderRadius: '12px', color: '#D1D5DB', cursor: 'pointer', fontSize: '0.95rem', fontWeight: '600', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' },
  modeBtnActive: { background: 'rgba(0, 217, 255, 0.15)', border: '2px solid #00D9FF', color: '#00D9FF', boxShadow: '0 0 20px rgba(0, 217, 255, 0.3)' },
  inputSection: { marginBottom: '2rem' },
  inputWrapper: { position: 'relative' },
  inputIcon: { position: 'absolute', left: '1.25rem', top: '50%', transform: 'translateY(-50%)', color: '#00D9FF', zIndex: 1 },
  input: { width: '100%', padding: '1.25rem 1.25rem 1.25rem 3.5rem', background: 'rgba(0, 217, 255, 0.03)', border: '2px solid rgba(0, 217, 255, 0.2)', borderRadius: '16px', color: '#FFFFFF', fontSize: '1rem', outline: 'none', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', boxSizing: 'border-box' },
  dropdown: { 
    position: 'absolute', 
    top: '100%', 
    left: 0, 
  ...
  locationBtn: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '1.25rem 1.5rem', background: 'rgba(0, 217, 255, 0.1)', border: '2px solid rgba(0, 217, 255, 0.3)', borderRadius: '16px', color: '#00D9FF', cursor: 'pointer', fontSize: '0.95rem', fontWeight: '600', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', whiteSpace: 'nowrap' },
  ...
  btn: { position: 'relative', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', border: 'none', color: '#000000', padding: '1.5rem', borderRadius: '16px', fontSize: '1.1rem', fontWeight: '700', cursor: 'pointer', overflow: 'hidden', boxShadow: '0 0 40px rgba(0, 217, 255, 0.4)', textTransform: 'uppercase', letterSpacing: '0.05em' },
  btnGlow: { position: 'absolute', inset: '-2px', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', filter: 'blur(20px)', opacity: 0.5, zIndex: -1 },
  ...
  loadText: { fontSize: '1.1rem', color: '#D1D5DB', marginBottom: '0.5rem' },
  loadSubtext: { fontSize: '0.95rem', color: '#D1D5DB', marginBottom: '2rem', fontStyle: 'italic' },
  loadingBar: { maxWidth: '400px', height: '8px', background: 'rgba(0, 217, 255, 0.2)', borderRadius: '8px', margin: '0 auto', overflow: 'hidden', position: 'relative' },
  loadingBarFill: { height: '100%', borderRadius: '8px' },
  progressText: { marginTop: '1rem', fontSize: '1.5rem', fontWeight: '700', color: '#00D9FF' },
  ...
  badge2: { display: 'inline-block', padding: '0.5rem 1rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '20px', fontSize: '0.875rem', color: '#00D9FF', marginBottom: '1rem', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' },
  ...
  reportSubtitle: { fontSize: '1rem', color: '#D1D5DB' },
  newBtn: { display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', border: 'none', color: '#000000', padding: '1rem 2rem', borderRadius: '16px', cursor: 'pointer', fontSize: '1rem', fontWeight: '700', boxShadow: '0 0 30px rgba(0, 217, 255, 0.4)', textTransform: 'uppercase', letterSpacing: '0.05em' },
  card: { background: 'rgba(0, 217, 255, 0.03)', backdropFilter: 'blur(20px)', border: '1px solid rgba(0, 217, 255, 0.1)', borderRadius: '20px', padding: '2.5rem', marginBottom: '2rem' },
  cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' },
  h2: { display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '1.75rem', fontWeight: '700', color: '#FFFFFF', margin: 0 },
  count: { padding: '0.5rem 1rem', background: 'rgba(0, 217, 255, 0.1)', borderRadius: '12px', fontSize: '0.875rem', color: '#00D9FF', fontWeight: '600' },
  textContent: { fontSize: '1.1rem', lineHeight: '1.8', color: '#D1D5DB' },
  themesGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '1.5rem' },
  themeCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' },
  themeTitle: { fontSize: '1.25rem', fontWeight: '700', color: '#FFFFFF', marginBottom: '0.75rem' },
  themeDesc: { fontSize: '0.95rem', color: '#D1D5DB', lineHeight: '1.6', marginBottom: '1rem' },
  themeStats: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  themeStat: { display: 'flex', flexDirection: 'column' },
  themeLabel: { fontSize: '0.85rem', color: '#D1D5DB', marginBottom: '0.25rem' },
  themeValue: { fontSize: '1.1rem', fontWeight: '700', color: '#FFFFFF' },
  categoriesGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1.5rem' },
  categoryCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)', textAlign: 'center' },
  categoryName: { fontSize: '0.95rem', color: '#D1D5DB', marginBottom: '0.75rem', fontWeight: '600' },
  categoryCount: { fontSize: '2rem', fontWeight: '700', color: '#00D9FF' },
  trendsGrid: { display: 'flex', flexDirection: 'column', gap: '1.5rem' },
  trendCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  trendTitle: { fontSize: '1.25rem', fontWeight: '700', color: '#FFFFFF', marginBottom: '0.75rem' },
  trendAnalysis: { fontSize: '0.95rem', color: '#D1D5DB', lineHeight: '1.6', marginBottom: '1rem' },
  trendVolume: { fontSize: '0.9rem', color: '#00D9FF', fontWeight: '600' },
  jsonOutput: { color: '#D1D5DB', whiteSpace: 'pre-wrap', wordWrap: 'break-word', fontSize: '0.875rem', lineHeight: '1.6' },
  
  // Enhanced Location Mode Styles
  highlightCard: { background: 'rgba(0, 217, 255, 0.05)', border: '2px solid rgba(0, 217, 255, 0.3)', boxShadow: '0 0 40px rgba(0, 217, 255, 0.2)' },
  summaryHeadline: { fontSize: '1.5rem', fontWeight: '700', color: '#FFFFFF', marginBottom: '1rem', lineHeight: '1.4' },
  summaryInsight: { fontSize: '1.05rem', color: '#D1D5DB', lineHeight: '1.7', marginBottom: '1rem' },
  actionBox: { padding: '1rem 1.5rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '12px', marginTop: '1rem', fontSize: '0.95rem', color: '#00D9FF' },
  statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '2rem' },
  statCard: { display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '2rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)', textAlign: 'center' },
  statValue: { fontSize: '2.25rem', fontWeight: '800', color: '#00D9FF', margin: '0.5rem 0' },
  statLabel: { fontSize: '0.9rem', color: '#D1D5DB', textTransform: 'uppercase', letterSpacing: '0.05em' },
  
  categoriesGrid2: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' },
  categoryCard2: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' },
  categoryHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  categoryTitle: { fontSize: '1.1rem', fontWeight: '700', color: '#FFFFFF', margin: 0 },
  categoryPercent: { fontSize: '1.5rem', fontWeight: '800', color: '#00D9FF' },
  categoryMeta: { display: 'flex', gap: '1rem', marginBottom: '0.75rem', fontSize: '0.85rem', color: '#D1D5DB' },
  ...
  exampleTag: { padding: '0.4rem 0.8rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '6px', fontSize: '0.8rem', color: '#00D9FF' },
  
  trendHeader: { display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' },
  trendRank: { display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', borderRadius: '12px', fontSize: '1.25rem', fontWeight: '800', color: '#000000', flexShrink: 0 },
  trendCategory: { display: 'inline-block', padding: '0.5rem 1rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '8px', fontSize: '0.85rem', color: '#00D9FF', marginBottom: '1rem', fontWeight: '600' },
  ...
  opportunitySection: { marginTop: '1rem', padding: '1rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '12px', border: '1px solid rgba(0, 217, 255, 0.2)' },
  oppHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem', color: '#00D9FF' },
  ...
  sectorTag: { padding: '0.4rem 0.8rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '6px', fontSize: '0.8rem', color: '#00D9FF' },
  
  insightsGrid: { display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '2rem' },
  insightCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  insightTitle: { fontSize: '1rem', fontWeight: '700', color: '#00D9FF', marginBottom: '0.75rem' },
  insightText: { fontSize: '0.95rem', color: '#D1D5DB', lineHeight: '1.7', marginBottom: '1rem' },
  insightMeta: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.85rem', color: '#D1D5DB' },
  confidenceBadge: { padding: '0.4rem 0.8rem', background: 'rgba(0, 217, 255, 0.2)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '8px', color: '#00D9FF', fontWeight: '600' },
  
  finalAssessment: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '2px solid rgba(0, 217, 255, 0.3)', marginTop: '1.5rem' },
  assessmentTitle: { fontSize: '1.25rem', fontWeight: '700', color: '#FFFFFF', marginBottom: '1rem' },
  assessmentText: { fontSize: '1rem', color: '#D1D5DB', lineHeight: '1.7', marginBottom: '1rem' },
  
  // NEW STYLES for enhanced keyword output
  geoTag: { padding: '0.4rem 0.8rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '6px', fontSize: '0.8rem', color: '#00D9FF', display: 'inline-block' },
  sampleTweet: { padding: '0.75rem', background: 'rgba(0, 217, 255, 0.02)', borderLeft: '3px solid rgba(0, 217, 255, 0.5)', borderRadius: '8px', fontSize: '0.9rem', color: '#D1D5DB', fontStyle: 'italic', marginBottom: '0.5rem' },
  driverCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.02)', borderRadius: '12px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  driverTitle: { fontSize: '1rem', fontWeight: '700', marginBottom: '1rem' },
  driverList: { listStyle: 'none', padding: 0, margin: 0 },
  driverItem: { padding: '0.5rem 0', borderBottom: '1px solid rgba(0, 217, 255, 0.05)', fontSize: '0.9rem', color: '#D1D5DB' },
  patternCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.02)', borderRadius: '12px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  patternTitle: { fontSize: '1rem', fontWeight: '700', marginBottom: '1rem' },
  patternList: { listStyle: 'none', padding: 0, margin: 0 },
  patternItem: { padding: '0.5rem 0.75rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '8px', marginBottom: '0.5rem', fontSize: '0.9rem', color: '#D1D5DB' },
  geoGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' },
  geoCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  geoHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  geoTitle: { fontSize: '1.25rem', fontWeight: '700', color: '#FFFFFF', margin: 0 },
  geoInsight: { fontSize: '0.95rem', color: '#D1D5DB', lineHeight: '1.6', marginBottom: '1rem' },
  geoThemeTag: { display: 'inline-block', padding: '0.4rem 0.8rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '6px', fontSize: '0.8rem', color: '#00D9FF', marginRight: '0.5rem', marginBottom: '0.5rem' },
  competitorGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' },
  competitorCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  competitorHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  competitorName: { fontSize: '1.1rem', fontWeight: '700', color: '#FFFFFF', margin: 0 },
  positionBadge: { padding: '0.4rem 0.8rem', borderRadius: '8px', fontSize: '0.8rem', fontWeight: '600' },
  competitorActivity: { fontSize: '0.9rem', color: '#D1D5DB', marginBottom: '0.75rem' },
  competitorNote: { fontSize: '0.85rem', color: '#D1D5DB', fontStyle: 'italic' },
  sectionSubtitle: { fontSize: '1.1rem', fontWeight: '700', color: '#00D9FF', marginBottom: '1rem' },
  behaviorCard: { padding: '1.5rem', background: 'rgba(0, 217, 255, 0.02)', borderRadius: '12px', border: '1px solid rgba(0, 217, 255, 0.1)', marginBottom: '1.5rem' },
  behaviorTitle: { fontSize: '1.1rem', fontWeight: '700', color: '#FFFFFF', marginBottom: '0.75rem' },
  behaviorDesc: { fontSize: '0.95rem', color: '#D1D5DB', lineHeight: '1.6', marginBottom: '1rem' },
  behaviorMeta: { fontSize: '0.9rem', color: '#D1D5DB', lineHeight: '1.6' },
  topicTag: { display: 'inline-block', padding: '0.5rem 1rem', background: 'rgba(0, 217, 255, 0.2)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '12px', fontSize: '0.9rem', color: '#00D9FF', fontWeight: '600' },
  audienceTag: { display: 'inline-block', padding: '0.3rem 0.6rem', background: 'rgba(0, 217, 255, 0.1)', border: '1px solid rgba(0, 217, 255, 0.3)', borderRadius: '6px', fontSize: '0.8rem', color: '#00D9FF', marginLeft: '0.5rem' },
  ...
  actionItem: { padding: '1rem', background: 'rgba(0, 217, 255, 0.02)', borderLeft: '3px solid rgba(0, 217, 255, 0.5)', borderRadius: '8px', marginBottom: '0.75rem', fontSize: '0.95rem', color: '#D1D5DB', lineHeight: '1.6' },
  ...
  metadataLabel: { fontSize: '0.85rem', color: '#D1D5DB', textTransform: 'uppercase', letterSpacing: '0.05em' },
  metadataValue: { fontSize: '1.25rem', fontWeight: '700', color: '#FFFFFF' }
};
...
.mode-btn:hover { background: rgba(0, 217, 255, 0.15) !important; transform: translateY(-2px); box-shadow: 0 0 30px rgba(0, 217, 255, 0.3); }
.location-btn:hover { background: rgba(0, 217, 255, 0.2) !important; transform: translateY(-2px); box-shadow: 0 0 30px rgba(0, 217, 255, 0.3); }
.location-btn:disabled { opacity: 0.5; cursor: not-allowed; }
.submit-btn:hover { transform: translateY(-2px); box-shadow: 0 0 60px rgba(0, 217, 255, 0.6) !important; }
.theme-card:hover, .category-card:hover, .trend-card:hover, .category-card-2:hover { transform: translateY(-4px); box-shadow: 0 0 40px rgba(0, 217, 255, 0.3); }
`;
