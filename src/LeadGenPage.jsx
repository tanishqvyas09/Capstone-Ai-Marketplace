...
const s = {
  container: { minHeight: '100vh', background: '#000000', color: '#FFFFFF', fontFamily: "'Space Grotesk', sans-serif" },
  header: { padding: '1.5rem 2rem', borderBottom: '1px solid rgba(0, 217, 255, 0.1)' },
  backBtn: { display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(0, 217, 255, 0.05)', border: '1px solid rgba(0, 217, 255, 0.2)', color: '#FFFFFF', padding: '0.75rem 1.5rem', borderRadius: '12px', cursor: 'pointer', fontSize: '0.95rem', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', fontFamily: "'Space Grotesk', sans-serif", fontWeight: '600' },
  hero: { textAlign: 'center', padding: '4rem 2rem' },
  heroIcon: { display: 'inline-flex', padding: '1.5rem', background: 'rgba(0, 217, 255, 0.1)', borderRadius: '20px', marginBottom: '1.5rem', border: '1px solid rgba(0, 217, 255, 0.3)', color: '#00D9FF', boxShadow: '0 0 30px rgba(0, 217, 255, 0.2)' },
  title: { fontSize: '3rem', fontWeight: '700', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: '1rem', fontFamily: "'Space Grotesk', sans-serif", letterSpacing: '-0.02em' },
  subtitle: { fontSize: '1.25rem', color: '#D1D5DB', fontFamily: "'Space Grotesk', sans-serif" },
  main: { maxWidth: '1400px', margin: '0 auto', padding: '2rem' },
  card: { background: 'rgba(0, 217, 255, 0.03)', backdropFilter: 'blur(20px)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '20px', padding: '2rem', marginBottom: '1.5rem', boxShadow: '0 0 40px rgba(0, 217, 255, 0.1)' },
  inputGroup: { display: 'flex', gap: '1rem', flexWrap: 'wrap' },
  input: { flex: 1, minWidth: '250px', padding: '1rem', background: 'rgba(0, 217, 255, 0.03)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '12px', color: '#FFFFFF', fontSize: '1rem', marginBottom: '1rem', boxSizing: 'border-box', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', fontFamily: "'Space Grotesk', sans-serif" },
  error: { display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', color: '#fca5a5', padding: '1rem', borderRadius: '12px', marginBottom: '1rem', fontFamily: "'Space Grotesk', sans-serif" },
  btn: { width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', border: 'none', color: '#000000', padding: '1.25rem', borderRadius: '12px', fontSize: '1.1rem', fontWeight: '700', cursor: 'pointer', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', boxShadow: '0 0 30px rgba(0, 217, 255, 0.4)', fontFamily: "'Space Grotesk', sans-serif", textTransform: 'uppercase', letterSpacing: '0.05em' },
  ...
  mapPin: { animation: 'bounce 2s infinite', zIndex: 3, color: '#00D9FF' },
  ripple1: { position: 'absolute', width: '100%', height: '100%', border: '2px solid #00D9FF', borderRadius: '50%', animation: 'ripple 2s infinite', opacity: 0 },
  ripple2: { position: 'absolute', width: '100%', height: '100%', border: '2px solid #0EA5E9', borderRadius: '50%', animation: 'ripple 2s infinite 0.5s', opacity: 0 },
  ripple3: { position: 'absolute', width: '100%', height: '100%', border: '2px solid #00D9FF', borderRadius: '50%', animation: 'ripple 2s infinite 1s', opacity: 0 },
  scanLine: { position: 'absolute', top: 0, left: 0, right: 0, height: '2px', background: 'linear-gradient(90deg, transparent, #00D9FF, transparent)', animation: 'scan 2s infinite' },
  loadTitle: { fontSize: '2rem', fontWeight: '700', marginBottom: '0.5rem', fontFamily: "'Space Grotesk', sans-serif", color: '#FFFFFF' },
  loadText: { fontSize: '1.1rem', color: '#D1D5DB', fontFamily: "'Space Grotesk', sans-serif" },
  ...
  reportTitle: { fontSize: '2.5rem', fontWeight: '700', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: '0.5rem', fontFamily: "'Space Grotesk', sans-serif", letterSpacing: '-0.02em' },
  reportSub: { fontSize: '1.1rem', color: '#D1D5DB', fontFamily: "'Space Grotesk', sans-serif" },
  ...
  h2: { display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.5rem', fontWeight: '700', marginBottom: '1.5rem', color: '#FFFFFF', fontFamily: "'Space Grotesk', sans-serif" },
  summaryGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem', marginBottom: '2rem' },
  summaryCard: { background: 'rgba(0, 217, 255, 0.03)', backdropFilter: 'blur(20px)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '20px', padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', boxShadow: '0 0 30px rgba(0, 217, 255, 0.1)' },
  summaryIcon: { width: '60px', height: '60px', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 0 30px rgba(0, 217, 255, 0.3)', background: 'rgba(0, 217, 255, 0.1)' },
  summaryContent: { flex: 1 },
  summaryLabel: { fontSize: '0.875rem', color: '#D1D5DB', marginBottom: '0.25rem', fontFamily: "'Space Grotesk', sans-serif" },
  summaryValue: { fontSize: '2rem', fontWeight: '700', color: '#FFFFFF', lineHeight: 1, fontFamily: "'Space Grotesk', sans-serif" },
  summaryHint: { fontSize: '0.75rem', color: '#6B7280', marginTop: '0.25rem', fontFamily: "'Space Grotesk', sans-serif" },
  leadCard: { background: 'rgba(0, 217, 255, 0.03)', border: '1px solid rgba(0, 217, 255, 0.2)', borderRadius: '16px', marginBottom: '1rem', overflow: 'hidden', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' },
  leadHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem', cursor: 'pointer', transition: 'background 0.3s cubic-bezier(0.4, 0, 0.2, 1)' },
  leadHeaderLeft: { display: 'flex', alignItems: 'center', gap: '1rem', flex: 1 },
  leadRank: { width: '40px', height: '40px', background: 'linear-gradient(135deg, #00D9FF, #0EA5E9)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '700', fontSize: '1rem', flexShrink: 0, color: '#000000', boxShadow: '0 0 20px rgba(0, 217, 255, 0.4)' },
  leadName: { fontSize: '1.1rem', fontWeight: '600', color: '#FFFFFF', marginBottom: '0.25rem', fontFamily: "'Space Grotesk', sans-serif" },
  leadCategory: { fontSize: '0.875rem', color: '#D1D5DB', fontFamily: "'Space Grotesk', sans-serif" },
  ...
  scoreText: { fontSize: '1.25rem', fontWeight: '700', fontFamily: "'Space Grotesk', sans-serif" },
  leadMetaBar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 1.5rem', background: 'rgba(0, 217, 255, 0.02)', borderTop: '1px solid rgba(0, 217, 255, 0.1)', flexWrap: 'wrap', gap: '1rem' },
  ratingSection: { display: 'flex', alignItems: 'center', gap: '0.75rem' },
  stars: { display: 'flex', gap: '2px' },
  ratingText: { fontSize: '0.875rem', color: '#D1D5DB', fontFamily: "'Space Grotesk', sans-serif" },
  conversionBadge: { padding: '0.5rem 1rem', borderRadius: '20px', fontSize: '0.875rem', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.5rem', fontFamily: "'Space Grotesk', sans-serif" },
  leadDetails: { padding: '1.5rem', borderTop: '1px solid rgba(0, 217, 255, 0.1)' },
  contactSection: { marginBottom: '1.5rem' },
  sectionTitle: { fontSize: '1rem', fontWeight: '600', color: '#FFFFFF', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', fontFamily: "'Space Grotesk', sans-serif" },
  contactGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' },
  contactItem: { display: 'flex', gap: '1rem', padding: '1rem', background: 'rgba(0, 217, 255, 0.03)', borderRadius: '12px', border: '1px solid rgba(0, 217, 255, 0.1)' },
  contactLabel: { fontSize: '0.75rem', color: '#D1D5DB', marginBottom: '0.25rem', fontFamily: "'Space Grotesk', sans-serif" },
  contactValue: { fontSize: '0.95rem', color: '#FFFFFF', wordBreak: 'break-word', fontFamily: "'Space Grotesk', sans-serif" },
  websiteLink: { display: 'inline-flex', alignItems: 'center', gap: '0.25rem', color: '#00D9FF', textDecoration: 'none', fontSize: '0.95rem', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', fontFamily: "'Space Grotesk', sans-serif" },
  insightsSection: { marginBottom: '1.5rem' },
  insightsGrid: { display: 'flex', gap: '0.75rem', flexWrap: 'wrap' },
  insightBadge: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem', borderRadius: '12px', fontSize: '0.875rem', fontWeight: '600', fontFamily: "'Space Grotesk', sans-serif" },
  scoreBreakdown: {},
  scoreBar: { height: '40px', background: 'rgba(0, 217, 255, 0.05)', borderRadius: '20px', overflow: 'hidden', position: 'relative', border: '1px solid rgba(0, 217, 255, 0.1)' },
  scoreBarFill: { height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', padding: '0 1rem', transition: 'width 1s cubic-bezier(0.4, 0, 0.2, 1)', borderRadius: '20px' },
  scoreBarText: { fontSize: '0.875rem', fontWeight: '700', color: '#000000', textShadow: 'none', fontFamily: "'Space Grotesk', sans-serif" },
  recommendationsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' },
  recCard: { display: 'flex', gap: '1rem', padding: '1.5rem', background: 'rgba(0, 217, 255, 0.03)', borderRadius: '16px', border: '1px solid rgba(0, 217, 255, 0.2)', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)' },
  recIcon: { width: '48px', height: '48px', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  recContent: { flex: 1 },
  recTitle: { fontSize: '1rem', fontWeight: '600', color: '#FFFFFF', marginBottom: '0.5rem', fontFamily: "'Space Grotesk', sans-serif" },
  recText: { fontSize: '0.875rem', color: '#D1D5DB', lineHeight: '1.5', fontFamily: "'Space Grotesk', sans-serif" },
};
...
css.textContent = `
  ...
  .lead-card:hover { transform: translateY(-2px); box-shadow: 0 0 40px rgba(0, 217, 255, 0.3); background: rgba(0, 217, 255, 0.05); }
  .lead-card .leadHeader:hover { background: rgba(0, 217, 255, 0.03); }
  input:focus { outline: none; border-color: #00D9FF; box-shadow: 0 0 0 3px rgba(0, 217, 255, 0.2); }
  button:hover { transform: translateY(-2px); box-shadow: 0 0 40px rgba(0, 217, 255, 0.6) !important; }
  .websiteLink:hover { color: #0EA5E9; }
  .summaryCard:hover { transform: translateY(-4px); box-shadow: 0 0 40px rgba(0, 217, 255, 0.3); }
  .recCard:hover { transform: translateY(-2px); background: rgba(0, 217, 255, 0.05); box-shadow: 0 0 30px rgba(0, 217, 255, 0.2); }
`;
